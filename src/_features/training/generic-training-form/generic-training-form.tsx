...
import { EstimatedMaximumWeightText } from "@/_features/exercise/estimated-maximum-weight-text/estimated-maximum-weight-text";
import { LatestRecordText } from "@/_features/exercise/latest-record-text/latest-record-text";
