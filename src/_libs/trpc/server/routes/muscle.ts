...
import { deleteMuscleCommand } from "@/_libs/prisma/commands/delete-muscle-command";
import { registerMuscleCommand } from "@/_libs/prisma/commands/register-muscle-command";
import { updateMuscleNameCommand } from "@/_libs/prisma/commands/update-muscle-name-command";
import { getAllMusclesQuery } from "@/_libs/prisma/queries/get-all-muscles-query";
import { getMuscleByIdQuery } from "@/_libs/prisma/queries/get-muscle-by-id-query";
import { getMuscleByNameQuery } from "@/_libs/prisma/queries/get-muscle-by-name-query";
import { getWeeklyNumberOfSetsByMuscleIdQuery } from "@/_libs/prisma/queries/get-weekly-number-of-sets-by-muscle-id-query";
